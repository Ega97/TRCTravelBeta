...
public class Login extends AppCompatActivity {
    ...
    TextView daftarbtn, masukDriver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        masuk = (Button) findViewById(R.id.btn_sign_in);
        masuk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LoginPenumpang(Susername, Spassword);
            }
        });
        masukDriver = findViewById(R.id.login_driver);
        masukDriver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Login.this, LoginDriver.class);
                startActivity(i);
            }
        });
        daftarbtn = (TextView) findViewById(R.id.daftar_akun);
        daftarbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Login.this, SignUpPenumpang.class);
                startActivity(i);
            }
        });

        if (sharedPrefManager.getIS_LOGIN()){
    ...
    private void LoginPenumpang(String susername, String spassword) {
        ...
        custParentCall.enqueue(new Callback<ResponLogin>() {
            ...
            public void onFailure(Call<ResponLogin> call, Throwable t) {
                Toast.makeText(Login.this, "Gagal Masuk cek koneksi", Toast.LENGTH_SHORT).show();     
            }
        });
    }
